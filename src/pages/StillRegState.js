...
<h4>Still birth Registrations by state</h4>
...
states.map((it,i)=>{
    ...
    <Link to={`/still/lga/${it.State_ID}`}>
    <span className='text-green-500 text-xs font-bold'>view lgas</span>
    </Link>
    
    

    <Link to={`/still/list?state=${it.State_ID}`}>
